...
local UBRS_TRASH_MOBS = {
    blackhand_assassin = {
        ...
        },
        {
            ...
            lines = {"Increases the caster's attack speed by 30% for X seconds."}
        },
        {
    ...
    blackhand_elite = {
        ...
        abilities = {{
        {
            ...
            icon = "Interface\\Icons\\INV_Gauntlets_05",
            warning = true,
            lines = {"Backhands an enemy, stunning it for X seconds."}
        },
        {
            name = "Head Crack",
        ...
        },
        {
            ...
            warning = true,
            lines = {"Inflicts 150% weapon damage to an enemy and leaves it wounded, reducing the effectiveness of any healing on it by 50% for X seconds."}
        },
        {
            name = "Retaliation",
    ...
    blackhand_incarcerator = {
        ...
        },
        {
            ...
            icon = "Interface\\Icons\\Ability_ThunderBolt",
            warning = true,
            lines = {"Encages an enemy, stunning it for X seconds."}
        },
        {
            name = "Strike",
            icon = "Interface\\Icons\\Ability_Rogue_Ambush",
    ...
    blackhand_iron_guard = {
        ...
        },
        {
            ...
            lines = {"X - no ability description available (real values live on linked spell 7376, not captured in this pass)."}
        },
        {
            name = "Shield Reflection",
            icon = "Interface\\Icons\\Ability_Warrior_ShieldReflection",
            lines = {"Raises its shield, reflecting a spell cast on it. Lasts X seconds, but will only reflect X spells."}
        },
        {
            name = "Shield Slam",
    ...
    chromatic_elite_guard = {
        ...
        },
        {
            ...
            icon = "Interface\\Icons\\Ability_Warrior_SavageBlow",
            warning = true,
            lines = {"Inflicts 300% weapon damage and leaves the target wounded, reducing the effectiveness of any healing by 50% for X seconds."}
        },
        {
            name = "Strike",
            icon = "Interface\\Icons\\Ability_Rogue_Ambush",
    ...
    rage_talon_captain = {
        ...
        },
        {
            ...
            warning = true,
            lines = {"Reduces the melee and ranged attack power of nearby enemies by 300, for X seconds."}
        },
        {
            name = "Empower Will",
    ...
    rage_talon_dragon_guard = {
        ...
        },
        {
            ...
            icon = "Interface\\Icons\\Ability_ThunderBolt",
            warning = true,
            lines = {"A brutal strike that deals weapon damage and stuns the opponent for X seconds."}
        },
        {
            name = "Hate to 50%",
            icon = "Interface\\Icons\\Spell_Shadow_SacrificialShield",
        ...
        },
        {
            ...
            icon = "Interface\\Icons\\Ability_Warrior_Sunder",
            warning = true,
            lines = {"Hacks at an enemy's armor, reducing it per stack (up to 5 stacks). Lasts X seconds."}
        }
        }}
    },
    ...
    rage_talon_dragonspawn = {
        ...
        },
        {
            name = "Fixate",
            icon = "Interface\\Icons\\Spell_Shadow_Charm",
            lines = {"Causes an enemy to fixate upon the caster and increases the caster's attack speed by 50% for X seconds. While fixated, the target is very reluctant to attack anything else."}
        },
        {
            name = "Strike",
            icon = "Interface\\Icons\\Ability_Rogue_Ambush",
    ...
    rookery_guardian = {
        ...
        },
        {
            ...
            icon = "Interface\\Icons\\Ability_Warrior_Cleave",
            warning = true,
            lines = {"Inflicts normal damage plus 55 to an enemy and its nearest allies, increasing the time between their attacks by 33%, for X seconds."}
        },
        {
            name = "Sunder Armor",
            icon = "Interface\\Icons\\Ability_Warrior_Sunder",
    ...
    scarshield_spellbinder = {
        ...
        },
        {
            ...
            warning = true,
            lines = {"Counters an enemy's spell, preventing the enemy from casting that spell again for X seconds. Generates a high amount of threat."}
        },
        {
            name = "Frost Nova",
            icon = "Interface\\Icons\\Spell_Frost_FrostNova",
...
local UBRS_BOSSES = {
    emberseer = {
        ...
        },
        {
            ...
            warning = true,
            roles = {"kick"},
            lines = {"Inflicts 3588 to 4512 Fire damage to an enemy and scorches the target for an additional 474 damage every X seconds, for X seconds."}
        },
        {
            name = "Fire Nova",
            icon = "Interface\\Icons\\Spell_Fire_SealOfFire",
    ...
    rend = {
        ...
        },
        {
            ...
            warning = true,
            lines = {
                "Shouts at an enemy, paralyzing it with terror for X seconds and causing all other nearby enemies to flee in fear.",
                "(No separate Spell.xlsx description for this rank - reused spell 19134's text since it's the same named ability.)"
            }
        },
        {
            name = "Mortal Strike",
            icon = "Interface\\Icons\\Ability_Warrior_SavageBlow",
            warning = true,
            lines = {"Inflicts 500% weapon damage and leaves the target wounded, reducing the effectiveness of any healing by 50% for X seconds."}
        },
        {
            name = "Whirlwind",
    ...
    gyth = {
        ...
        },
        {
            ...
            warning = true,
            lines = {"Shoots a cloud of acidic breath at enemies in a cone in front of the caster, reducing their armor by 90 and inflicting 150 Nature damage every X seconds, for X seconds."}
        },
        {
            name = "Flame Breath",
    ...
    the_beast = {
        ...
        },
        {
            ...
            warning = true,
            lines = {"Burns an enemy for 42, then inflicts an additional 144 Fire damage every X seconds, for X seconds."}
        },
        {
            name = "Fireball",
            icon = "Interface\\Icons\\Spell_Fire_FlameBolt",
    ...
    drakkisath = {
        ...
        },
        {
            ...
            lines = {
                ...
                "While affected, the flames periodically scorch its nearby allies for X damage as well (linked spell 16806 not captured in this pass)."
            }
        },
        {
            name = "Flamestrike",
        ...
        },
        {
            name = "Rage",
            icon = "Interface\\Icons\\Spell_Shadow_UnholyFrenzy",
            lines = {"Increases the Physical damage dealt by the caster by 50 and speeds its attacks by 50% for X seconds."}
        },
        {
            name = "Thunderclap",
